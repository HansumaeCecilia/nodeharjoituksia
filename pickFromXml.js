...
const time = require('./pickTimeValue');
...
// class TimeAndPlaceObject {
//   constructor(timestamp, longitude, latitude){
...
xml2objectArray(xmlData, dataTemplate).then(result => {
  ...
  console.log(time.xml2objectArray)
});

// A template to get timestamps and positions
const timeTemplate = ['wfs:FeatureCollection/wfs:member/omso:PointTimeSeriesObservation/om:result/wml2:MeasurementTimeseries/wml2:point/wml2:MeasurementTVP',
{
  timestamp: 'wml2:time',  
}];
